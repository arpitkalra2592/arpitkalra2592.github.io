$(document).ready(function() {
	...
	$(window).scroll(function(){
	  ...
	  if ($(window).scrollTop() >= 81) {
		$('.notification-js').addClass('notification-fixed');
	   }
	   else {
		$('.notification-js').removeClass('notification-fixed');		
	   }
	});
	$(window).scroll(function(){
	...
	$('.top-btn').click(function(){
	 ...
	 // scroll Top 
	$('.Updateyour').click(function(){
		$(this).parent().parent().addClass('UpdateyourBlock');
	 });
